            ...
            <RadioGroup value={theme} onChange={setTheme}>
              <div className="p-1">
                <Radio value="light">
                  <MenuItem>
                    <button
                      className="group flex w-full items-center rounded-md px-2 py-2 text-sm text-gray-700 hover:bg-blue-50 data-[focus]:bg-blue-600 data-[focus]:text-white dark:text-gray-300 dark:hover:bg-gray-700"
